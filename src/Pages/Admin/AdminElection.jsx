...
import {FormatListBulleted, AddCircleOutlineOutlined, GridViewOutlined} from '@mui/icons-material';
  ...
  const dashboardCards = [
    {
      ...
      description: "Browse through the list of all elections. You can view election details and results.",
    ...
    },
    {
      ...
      description: "Start a new election by setting up election parameters and candidates.",
